...
try {
    ...
    // 5. Check for "Force Finalizing (1.5s Silence" string (specific to robust version)
    if (!content.includes("Force Finalizing (1.5s Silence")) {
        console.error("FAIL: Working logic (1.5s Silence Rule) seems missing.");
        process.exit(1);
    }
